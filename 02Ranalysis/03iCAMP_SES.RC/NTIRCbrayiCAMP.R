...
bac.icamp.res = icamp.big(bac.otu,bac.tree,nworker = NWORKER,detail.null = TRUE,bin.size.limit=24,sig.index="SES.RC",
...
fgi.icamp.res = icamp.big(fgi.otu,fgi.tree,nworker = NWORKER,detail.null = TRUE,bin.size.limit=12,sig.index="SES.RC",
