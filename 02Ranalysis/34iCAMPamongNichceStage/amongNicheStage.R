...
bac.icamp = read.csv("../02.3iCAMP_confidence_updated/bac.iCAMP.process.CbMPDiCBraya.csv")[-1]
...
fgi.icamp = read.csv("../02.3iCAMP_confidence_updated/fgi.iCAMP.process.CbMPDiCBraya.csv")[-1]
...
ggsave("bac.fgi.arrangeProcess.pdf",width = 8.5,height = 7.2,units = 'cm')
#ggsave("bac.fgi.arrangeProcess.pdf",width = 8,height = 7,units = 'cm')